...
interface VariantSelectorProps {
  ...
  onAddToCart: (sku: string, quantity: number) => void; // Placeholder for now
}
        ...
        {variants.map((variant) => {
          ...
          return (
            <Button
              ...
              disabled={isOutOfStock && !isSelected} // Allow selecting OOS to see it's OOS
            >
        ...
        <div className="mt-6 p-4 border rounded-lg bg-muted/20">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Button
              ...
              disabled={getVariantStock(selectedVariantDetails.sku) <= 0}
