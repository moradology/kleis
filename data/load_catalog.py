...
2. Loads substance and variant data from products.yaml
3. Sets up inventory records for each variant
    ...
    if 'substances' in data:
        ...
        for substance in data['substances']:
            ...
            for field in ['sequence', 'sequence_length', 'molecular_weight',
                         'formula', 'purity_percent', 'salt_form', 'physical_form',
            ...
            if 'variants' in substance:
                ...
                for variant in substance['variants']:
                    ...
                    in_stock = 1 if quantity > 0 else 0
                    cursor.execute(
                        "INSERT INTO inventory (variant_id, quantity, in_stock) VALUES (?, ?, ?)",
                        (variant_id, quantity, in_stock)
                    )
